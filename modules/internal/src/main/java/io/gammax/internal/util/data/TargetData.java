...
//
//public class TargetData { TODO TODO
...
//            case NEW, CHECK_CAST, INSTANCEOF ->
//                    target.owner() != void.class ? target.owner().getName().replace('.', '/') : null;
//            case LOAD, STORE ->
//                    target.signature().result() != void.class ? DescriptorFormat.getDescriptor(target.signature().result()) : null;
//            default -> null;
//        };
//    }
//
